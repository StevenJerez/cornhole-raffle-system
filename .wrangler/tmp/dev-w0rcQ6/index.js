...
// .wrangler/tmp/bundle-MuLvxb/checked-fetch.js
...
function buildParticipantsRows(state) {
  ...
  allEmails.forEach((email) => {
    ...
    const hasPending = regs.some((reg) => (reg.attempts_remaining || 0) > 0);
    const status = regs.length ? hasPending ? "pending" : "complete" : "pending";
    rows.push({
...
// .wrangler/tmp/bundle-MuLvxb/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-MuLvxb/middleware-loader.entry.ts
